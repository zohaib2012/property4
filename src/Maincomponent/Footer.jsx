...
<footer className="footer bg-secondary py-4">
  <div className=" container">
    ...
    <div className="row py-4">
      ...
      <img src="/public/smalllogo.jpg"className='img-fluid ' alt="error" />
        {/* <p className="">Trusted in more than 100 countries &amp; 5 million customers. Have any query ?</p> */}
        <ul className="text-sm  list-none pt-2">
          <li className=""><a href="/contactUs" className="">Contact us?</a></li>
          <li className=""><a href="/" className=" "><span>  <i className="fa-solid fa-envelope pe-2"></i></span>Al-Arabproperty@gmail.com</a></li>
      ...
      <div className="col-md-2 ">
        ...
        <li className="mb-6"><a href="/contactUs">Contact Us</a></li>
          <li className="mb-6"><a href="/properties?purpose=Sale" >Properties For Sale in Pakistan</a></li>
          <li className="mb-6"><a href="/properties?purpose=Rent" >Properties For Rent in Pakistan</a></li>    
        </ul>
      </div>
      <div className="col-md-2 ">
        <p className="">Quick links</p>
        <ul className="text-sm  list-none">
          <li className=""><a href="/properties?propertyType=House&purpose=Sale" className="">Houses For Sale</a></li>
          <li className=""><a href="/properties?propertyType=Flat&purpose=Sale" className=" ">Flats For Sale</a></li>
          <li className=""><a href="/properties?propertyType=Plot&purpose=Sale" className=" ">Plots For Sale</a></li>
          <li className=""><a href="/properties?propertyType=Shop&purpose=Sale" className=" ">Shops For Sale</a></li>
        </ul>
      </div>
      <div className="col-md-2 ">
        <p className="">Location</p>
        <ul className="text-sm  list-none">
        <li className="mb-6"><a href="/" className="text-gray-600 hover:text-gray-900">479-A Bismillah Centre Revenue Society, Johar Town, Lahore</a></li>
          <li className="mb-6"><a href="/" className=" text-gray-600 hover:text-gray-900"> Monday To Saturday 9AM To 6PM</a></li>
          <li className="mb-6"><a href="/" className=" text-gray-600 hover:text-gray-900"></a></li>
    ...
    {/*Grid*/}
    <div className="pt-3 border-top border-gray-500">
      <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
        <span className="text-sm text-gray-500 ">©<a href="https://pagedone.io/">Al-Arab Property</a> 2024, All rights reserved.</span>
